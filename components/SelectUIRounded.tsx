...
export default function SelectUIRounded({ options }: OptionTypes) {
    ...
    <div className="text-left w-full">
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative">
          <Listbox.Button className="relative w-full cursor-default py-3 px-3 lg:px-6 flex gap-3 items-center sm:text-sm bg-white border rounded-full">
