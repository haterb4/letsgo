...
const Cta = () => {
  return (
    <section className="relative after:bg-white after:absolute after:w-full after:h-[50%] after:bottom-0 after:left-0">
      <div className="z-10 relative after:bg-[url('/img/cta-bg.png')] after:absolute after:left-0 3xl:after:left-[12%] 4xl:after:left-[16%] after:w-[98%] after:mx-auto lg:after:w-[84%] after:h-full after:right-0 after:bottom-0 after:bg-[#c2c3f7]">
