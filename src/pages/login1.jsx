            ...
            <div className={styles.centercontainer}>
                ...
                <div className={styles.login}>
                    <form action="" className={styles.myform} onSubmit={handleSubmit}>
                        ...
                        <input ref={emailRef} type="text" id='email' name='email' className = {`${styles.inputtext} ${!conform_email && styles.input_warning}`} onChange={emailChange} placeholder='Email' required/>
