...
export function createAutocomplete(inputId){
    new Autocomplete(inputId, {
        ...
        onSearch: ({ currentValue }) => {
          ...
          return new Promise((resolve) => {
            fetch(api)
              ...
              .then((data) => {
                resolve(data.features); //console.log(api, data.features);
              })
              .catch((error) => {
                console.error(error);
              });
        ...
        //   )
          ...
          .map((feature) => `<li><span class="font-bold py-2">${feature.properties.name}</span><br/>
          ${feature.properties.state || feature.properties.county || ""}, ${feature.properties.country}
          </li>`)
          .join("");
        },
      });
