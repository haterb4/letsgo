...
const BienvenueCard = () => {
    ...
    return (
        <div className="bienvenue-card flex justify-between place-items-center text-white h-40 md:h-52
        ...
        <div className="img relative pt-20 md:pt-28 h-full -left-20 sm:-left-24 lg:-left-28">
            ...
            <div className="absolute w-32 h-32 z-0 top-28 md:top-36 -left-8 cercle bg-beige"></div>

            <div className="nonPermanent">
                <div className="absolute circle-lg bg-beige z-0 top-16 -left-8"></div>
                <div className="absolute circle-sm bg-beige z-0 top-40 -left-16"></div>
