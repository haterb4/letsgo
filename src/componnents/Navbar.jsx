    ...
    <nav className='w-full h-16 flex justity-between items-center bg-white px-8'>
      <div className='w-full flex justify-between items-center'>
        <div className='w-64 flex justify-between items-center'>
          ...
          <Link href='/' className='text-black-600 font-bold text-2xl'>Let's Go!</Link>
          </div>
        <div className='w-full flex justify-end items-center gap-6'>
          <Link href='/' className='text-xl'> Covoiturage</Link>
          <Link href='/' className='text-xl'>Taxi</Link>
          <Link href='/' className='text-xl'>Rechercher</Link>
          <Link href='/' className='text-xl'>Trajet </Link>
          <Link href='/' className='text-xl'>Partenaires</Link>
          <Link href='/' className='text-xl'>Tarifs</Link>
